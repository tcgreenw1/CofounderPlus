/**
 * Task Automation Setup Booking Page
 * Reused booking flow from Founder Setup Call
...
export function TaskAutomationBooking() {
      ...
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-373d8b09/founder-calls/book`,
        {
          ...
          body: JSON.stringify({
            ...
            bookingType: 'task_automation', // Explicit booking type
            ...formData,
            // Add a note about the type of call
            notes: `Task Automation Setup - ${formData.mainChallenge}`
          }),
        }
      );
      ...
      {isProcessing && (
        ...
        >
          ...
          >
            ...
            <p className="text-foreground font-medium">Processing booking...</p>
          </div>
        </div>
      )}
    </div>

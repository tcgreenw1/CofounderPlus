          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px 0; color: #333333; font-size: 16px; line-height: 1.6;">
                Cofounder is a tool-powered business growth platform that helps entrepreneurs and teams build, manage, and scale their businesses with cutting-edge tools and insights.
              </p>
              ...
              <div style="background-color: #f8f9fa; border-radius: 12px; padding: 24px; margin: 32px 0;">
                ...
                <ul style="margin: 0; padding: 0 0 0 20px; color: #333333; font-size: 15px; line-height: 1.8;">
                  <li>Tool-powered business assistant</li>
...
Cofounder is a tool-powered business growth platform that helps entrepreneurs and teams build, manage, and scale their businesses.

Accept your invitation by visiting this link:
${inviteLink}

What you'll get access to:
• Tool-powered business assistant
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 16px 0; color: #333333; font-size: 16px; line-height: 1.6;">
                We're thrilled to have you join Cofounder! You've just unlocked a powerful suite of tool-driven capabilities designed to help you build, manage, and scale your business.
              </p>
              ...
              <div style="background-color: #f8f9fa; border-radius: 12px; padding: 24px; margin: 24px 0;">
                ...
                <ul style="margin: 0; padding: 0 0 0 20px; color: #333333; font-size: 15px; line-height: 1.8;">
                  <li><strong>Tool Business Assistant:</strong> Get instant answers and strategic advice</li>
...
What's inside:
• Tool Business Assistant: Get instant answers and strategic advice
